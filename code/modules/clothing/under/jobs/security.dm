...
/obj/item/clothing/head/police
	name = "gorro de Policía"
	desc = "Un gorro que usan los oficiales de policía en la ciudad."
	icon_state = "police_s"
	item_state = "police_s"
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
...
/obj/item/clothing/under/police
	desc = "Un uniforme utilizado por los oficiales de policía."
	name = "uniforme de Policía"
	icon_state = "police_s"
	item_state = "police_s"
	worn_state = "police_s"
	armor = list(
...
/obj/item/clothing/under/policejefe
	desc = "Un uniforme utilizado por el Policía en Jefe."
	name = "uniforme de Policía en Jefe"
	icon_state = "policej_s"
	item_state = "policej_s"
	worn_state = "policej_s"
	armor = list(
		melee = ARMOR_MELEE_RESISTANT,
		laser = ARMOR_LASER_SMALL,
		energy = ARMOR_ENERGY_MINOR
