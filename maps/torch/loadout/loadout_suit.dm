...
/datum/gear/suit/wintercoat_fleet
	...
	cost = 2
	allowed_branches = NT_BRANCHES
	allowed_roles = list(/datum/job/captain, /datum/job/hop, /datum/job/rd, /datum/job/cmo, /datum/job/chief_engineer, /datum/job/hos, /datum/job/representative, /datum/job/sea, /datum/job/bridgeofficer)
